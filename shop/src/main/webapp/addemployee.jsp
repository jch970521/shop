	...
	<form action="<%=request.getContextPath()%>/employeeInsertAction.jsp" method="post">
		<table border="1">
			...
			<tr>
				...
				<td><input type="text" name="employeeAddress" id="employeeAddress" readonly>
					<button type="button" id="addBtn" onclick="sample2_execDaumPostcode()" > 주소검색 </button><br>
				</td>
			</tr>
			<tr>
				<td>상세 주소 입력</td>
				<td><input type="text" name="employeeDetail" id="employeeDetail"></td>
			</tr>
		</table>
		<button type="submit">회원가입하기</button>
		<a href="<%=request.getContextPath()%>/loginForm.jsp">돌아가기</a>
	</form>
	<!-- 주소 추가 api 끌어오기 -->
    ...
    function sample2_execDaumPostcode() {
        new daum.Postcode({
            oncomplete: function(data) {
                ...
                // $('#address').val(data.zonecode + ' ' + addr);
